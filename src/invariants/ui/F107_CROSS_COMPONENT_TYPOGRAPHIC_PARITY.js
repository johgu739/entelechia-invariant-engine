...
export const F107_CROSS_COMPONENT_TYPOGRAPHIC_PARITY = {
    category: 'UI_TYPOGRAPHY',
    code: 'F107',
    ...
    enforce: (_node, context) => {
        const typographicParityViolations = context.typographicParityViolations;
        if (typographicParityViolations && typographicParityViolations.length > 0) {
            throw new InvariantViolationError('UI_TYPOGRAPHY.F107', 'UI_TYPOGRAPHY', 'F107', 'F107 violation: Cross-component typographic parity violations detected. Components of the same class must share the same typography.', {
...
//# sourceMappingURL=F107_CROSS_COMPONENT_TYPOGRAPHIC_PARITY.js.map