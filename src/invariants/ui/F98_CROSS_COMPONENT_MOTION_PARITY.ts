...
export const F98_CROSS_COMPONENT_MOTION_PARITY: InvariantDefinition = {
  category: 'UI_TYPOGRAPHY',
  code: 'F98',
  ...
  enforce: (_node: HTMLElement | null, context: InvariantContext): void => {
    const crossComponentViolations = context.crossComponentViolations as Array<{ parent: string; child: string; violation: string }> | undefined
    ...
    if (crossComponentViolations && crossComponentViolations.length > 0) {
      throw new InvariantViolationError(
        ...
        'UI_TYPOGRAPHY',
        'F98',
        'F98 violation: Cross-component motion parity violations detected. Child motion cannot contradict parent motion.',
        {
