...
export const F108_NO_VISUAL_DOPPELGANGERS = {
    category: 'UI_TYPOGRAPHY',
    code: 'F108',
    ...
    enforce: (_node, context) => {
        const doppelgangerViolations = context.doppelgangerViolations;
        if (doppelgangerViolations && doppelgangerViolations.length > 0) {
            throw new InvariantViolationError('UI_TYPOGRAPHY.F108', 'UI_TYPOGRAPHY', 'F108', 'F108 violation: Visual doppelganger violations detected. Two elements that look similar must behave and style identically.', {
...
//# sourceMappingURL=F108_NO_VISUAL_DOPPELGANGERS.js.map