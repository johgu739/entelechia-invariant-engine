...
export const F1_TEXT_ID_IS_FORM = {
    category: 'DOMAIN_LOGIC',
    code: 'F1',
    ...
    enforce: (_node, context) => {
        ...
        if (!nodeId || typeof nodeId !== 'string' || nodeId.trim() === '') {
            throw new InvariantViolationError('DOMAIN_LOGIC.F1', 'DOMAIN_LOGIC', 'F1', 'F1_TEXT_ID_IS_FORM violation: nodeId is missing, empty, or not a valid text-ID. Text-ID must be a non-empty string and is the canonical identifier (FORM) for nodes.', {
                nodeId,
                sourceComponent,
...
//# sourceMappingURL=F1_TEXT_ID_IS_FORM.js.map