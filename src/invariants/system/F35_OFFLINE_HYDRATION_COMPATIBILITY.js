...
export const F35_OFFLINE_HYDRATION_COMPATIBILITY = {
    category: 'SYSTEM_STATE',
    code: 'F35',
    ...
    enforce: (_node, context) => {
        const requiresNetworkForFirstFrame = context.requiresNetworkForFirstFrame;
        ...
        if (isOffline && requiresNetworkForFirstFrame && hasPersistedSnapshot) {
            throw new InvariantViolationError('SYSTEM_STATE.F35', 'SYSTEM_STATE', 'F35', 'F35 violation: Network required for first frame when persisted snapshot exists. Must hydrate from snapshot offline.', {
...
//# sourceMappingURL=F35_OFFLINE_HYDRATION_COMPATIBILITY.js.map